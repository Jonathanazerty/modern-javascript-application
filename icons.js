export function iconImages(weatherData) {
    let icon1 = weatherData["list"][0]["weather"][0]["icon"];
    let img1 = document.querySelector(".weatherIcon");
    img1.setAttribute('src', `http://openweathermap.org/img/wn/${icon1}@2x.png`);
